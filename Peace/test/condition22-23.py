...
filtered22_1 = dataframe.loc[dataframe['G/L'].str.contains((condition22), regex=True)]
...
filtered23_1 = dataframe.loc[dataframe['G/L'].str.contains((condition22), regex=True)]
