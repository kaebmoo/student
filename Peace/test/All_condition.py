    ...
    if pd.isna(row['เงื่อนไข 2']):
        match row['เงื่อนไข 1']:
            case 'บันทึกรหัสกระบวนการทางธุรกิจ':
                ...
                NoBP.to_csv('./Peace/test/All_condition_result/saved_act.csv', mode='a', index = False, header=write_header_bp)
            ...
            case 'บันทึกรหัสกระบวนการทางธุรกิจ (กิจกรรม R, N, E)':
                ...
                NotRNE.to_csv('./Peace/test/All_condition_result/act_RNE.csv', mode='a', index = False, header=write_header_rne)
            ...
            case 'บันทึกรหัสกระบวนการทางธุรกิจ (N)':
                ...
                NotN.to_csv('./Peace/test/All_condition_result/act_N.csv', mode='a', index = False, header=write_header_n)
            ...
            case 'บันทึกรหัสกระบวนการทางธุรกิจ (กิจกรรม J)':
                ...
                NotJ.to_csv('./Peace/test/All_condition_result/act_J.csv', mode='a', index = False, header=write_header_j)
            ...
            case 'รหัสบัญชี 51XXXXXX เท่านั้น':
                ...
                Not51.to_csv('./Peace/test/All_condition_result/GL51.csv', mode='a', index = False, header=write_header_51)
                write_header_51 = False

            case 'รหัสบัญชี 54XXXXXX เท่านั้น':
                filtered = dataframe.loc[dataframe['Bus. Process'].str.contains((row['รหัส']+'$'), na=False, regex=True)]
                Not54 = filtered.loc[filtered['G/L'].str.contains(('^54'), regex=True)]
                Not54.to_csv('./Peace/test/All_condition_result/GL54.csv', mode='a', index = False, header=write_header_54)
                write_header_54 = False

            case 'บันทึกเข้า Product 192020001':
                NotP = filtered[filtered['ผลิตภัณฑ์/'].str.contains(('192020001'), na=False)]
                NotP.to_csv('./Peace/test/All_condition_result/Product192020001.csv', index = False, mode='a', header=write_header_P192)
            ...
            case 'ยกเลิก/ห้ามบันทึก':
                ...
                specific_cancel_act.to_csv('./Peace/test/All_condition_result/SCA.csv', index = False, mode='a', header=write_header_sca)
            ...
            case 'บันทึกรหัสกระบวนการทางธุรกิจ (กิจกรรม E, N)':
                ...
                NotEN.to_csv('./Peace/test/All_condition_result/act_EN.csv', mode='a', index = False, header=write_header_en)
            ...
            case 'บันทึกรหัสกระบวนการทางธุรกิจ (กิจกรรม E, J)':
                ...
                NotEJ.to_csv('./Peace/test/All_condition_result/act_EJ.csv', mode='a', index = False, header=write_header_ej)
            ...
            case 'ห้ามบันทึกรหัส Product ยกเลิก':
                ...
                saved_cancel_product.to_csv('./Peace/test/All_condition_result/not_cancel_product.csv', mode='a', index = False, header=write_header_scp)
            ...
            case 'ห้ามบันทึกรหัสกิจกรรมที่ยกเลิก':
                ...
                saved_cancel_act.to_csv('./Peace/test/All_condition_result/not_cancel_act.csv', mode='a', index = False, header=write_header_cancel_act)
        ...
        NoBP_excluded.to_csv('./Peace/test/All_condition_result/saved_act_excluded.csv', mode='a', index = False, header=write_header_bp_ex)
